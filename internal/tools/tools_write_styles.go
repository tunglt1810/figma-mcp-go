...
var writeStyleSpecs = []toolSpec{
	{
		...
		Params: []paramSpec{
			...
			{Name: "color", Kind: kindString, IsHexColor: true,
				Desc: "Hex. PAINT: required. EFFECT: default #000000. GRID: default #FF0000."},
			{Name: "opacity", Kind: kindNumber,
				Desc: "0-1. EFFECT default 0.25, GRID default 0.1."},

			{Name: "fontSize", Kind: kindNumber, Desc: "Default 16"},
			{Name: "fontFamily", Kind: kindString,
				Desc: "Default Inter"},
			{Name: "fontStyle", Kind: kindString,
				Desc: "e.g. 'Bold' (default Regular)"},
			{Name: "textDecoration", Kind: kindString, Enum: []string{"NONE", "UNDERLINE", "STRIKETHROUGH"},
				Desc: "NONE (default), UNDERLINE, STRIKETHROUGH"},
			{Name: "lineHeightValue", Kind: kindNumber, Desc: "Line height"},
			{Name: "lineHeightUnit", Kind: kindString, Enum: []string{"PIXELS", "PERCENT"},
				Desc: "PIXELS (default) or PERCENT"},
			{Name: "letterSpacingValue", Kind: kindNumber, Desc: "Letter spacing"},
			{Name: "letterSpacingUnit", Kind: kindString, Enum: []string{"PIXELS", "PERCENT"},
				Desc: "PIXELS (default) or PERCENT"},

			{Name: "effectType", Kind: kindString, Enum: effectTypes,
				Desc: "DROP_SHADOW (default), INNER_SHADOW, LAYER_BLUR, BACKGROUND_BLUR"},
			{Name: "radius", Kind: kindNumber, Desc: "Blur (default 8 shadow, 4 blur)"},
			{Name: "offsetX", Kind: kindNumber, Desc: "Default 0"},
			{Name: "offsetY", Kind: kindNumber, Desc: "Default 4"},
			{Name: "spread", Kind: kindNumber, Desc: "Default 0"},

			{Name: "pattern", Kind: kindString, Enum: []string{"GRID", "COLUMNS", "ROWS"},
				Desc: "GRID (default), COLUMNS, ROWS"},
			{Name: "count", Kind: kindNumber, Desc: "Columns/rows count (default 12)"},
			{Name: "gutterSize", Kind: kindNumber, Desc: "Gutter (default 16)"},
			{Name: "offset", Kind: kindNumber, Desc: "Margin (default 0)"},
			{Name: "alignment", Kind: kindString, Enum: []string{"STRETCH", "CENTER", "MIN", "MAX"},
				Desc: "STRETCH (default), CENTER, MIN, MAX"},
			{Name: "sectionSize", Kind: kindNumber, Desc: "Cell size (default 8)"},
		},
	...
	},
	{
		...
		Params: []paramSpec{
			...
			{Name: "color", Kind: kindString, IsHexColor: true, Desc: "New color hex"},
	...
	{
		Name: "delete_style",
		Desc: "Delete a style by ID.",
		Params: []paramSpec{
			{Name: "styleId", Kind: kindString, Required: true, Desc: "Style ID"},
		},
	},
	{
		Name:       "apply_style_to_node",
		Desc:       "Apply a local style to a node.",
		NodeIDs:    nodeIDsSingle,
		NodeIDsReq: true,
		NodeIDDesc: "Target node ID",
		Params: []paramSpec{
			{Name: "styleId", Kind: kindString, Required: true, Desc: "Style ID from get_styles"},
			{Name: "target", Kind: kindString, Enum: []string{"fill", "stroke"},
				Desc: "Paint styles: fill (default) or stroke"},
		},
	},
	{
		Name:       "set_effects",
