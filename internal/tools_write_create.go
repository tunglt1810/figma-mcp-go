...
func frameParams() []paramSpec {
	...
	params = append(params,
		...
		paramSpec{Name: "fillColor", Kind: kindString, Desc: "Fill color as hex e.g. #FFFFFF"},
	)
...
var writeCreateSpecs = []toolSpec{
	...
	},
	{
		...
		Params: append(boxParams(),
			...
			paramSpec{Name: "fillColor", Kind: kindString, Desc: "Fill color as hex e.g. #FF5733"},
	...
	},
	{
		...
		Params: append(boxParams(),
			...
			paramSpec{Name: "fillColor", Kind: kindString, Desc: "Fill color as hex e.g. #3B82F6"},
	...
	},
	{
		...
		Params: append(positionParams(),
			...
			paramSpec{Name: "strokeColor", Kind: kindString, Desc: "Stroke color as hex e.g. #000000"},
	...
	},
	{
		...
		Params: append([]paramSpec{
			...
			paramSpec{Name: "fillColor", Kind: kindString, Desc: "Text color as hex e.g. #000000 (default black)"},
