...
var writeStyleSpecs = []toolSpec{
	{
		...
		Params: []paramSpec{
			...
			{Name: "color", Kind: kindString, Required: true, Desc: "Fill color as hex e.g. #FF5733"},
	...
	},
	{
		...
		Params: []paramSpec{
			...
			{Name: "color", Kind: kindString, Desc: "Shadow color as hex e.g. #000000 (default #000000, shadows only)"},
	...
	},
	{
		...
		Params: []paramSpec{
			...
			{Name: "color", Kind: kindString, Desc: "Grid line color as hex e.g. #FF0000 (GRID only, default #FF0000)"},
	...
	},
	{
		...
		Params: []paramSpec{
			...
			{Name: "color", Kind: kindString, Desc: "New fill color as hex e.g. #FF5733"},
