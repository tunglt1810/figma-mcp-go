...
- For fill overrides: use set_paint(nodeId: "target-node-id", type: "SOLID", color: "#hexcolor")
- For stroke overrides: use set_paint(nodeId: "target-node-id", type: "SOLID", target: "stroke", color: "#hexcolor")
